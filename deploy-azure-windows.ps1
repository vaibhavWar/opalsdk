# Azure Deployment Script for Windows App Service
# For deploying to Windows with .NET 8

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Product Description Generator - Windows Azure Deployment" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  App Service Plan: $AppServicePlan (Windows)"
Write-Host "  SKU: $Sku"
...
# Confirm
Write-Host ""
Write-Host "Ready to deploy to WINDOWS App Service. Continue? (y/n): " -NoNewline -ForegroundColor Yellow
$confirm = Read-Host
...
Write-Host ""
Write-Host "Step 4/6: Creating Windows App Service Plan..." -ForegroundColor Yellow
...
# Create Web App (Windows - no runtime flag needed)
Write-Host ""
Write-Host "Step 5/6: Creating Windows Web App..." -ForegroundColor Yellow
az webapp create `
    --resource-group $ResourceGroup `
    --plan $AppServicePlan `
    --name $webAppName `
